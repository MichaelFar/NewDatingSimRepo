...
text = "B/Garfield/B is beset by many attackers, B/Jon/B cowers in fear as B/Nermal/B raises his arm to deal the final blow"
extModifier = 60;
boldPos[0] = "";
var _buffer = "";
...
//testSub = string_width(boldWord[i]);